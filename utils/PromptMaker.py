...
"""
    ...
    def getPrompt(self, contextNum: int = 22, outputNum: int = 20):
        ...
        addText(
            f"プロンプトの数{len(prompt)}, 制限文字数:{self.outputNum}字",
            Path("tmpTextDir/tmpprompt.txt"),
            encoding="utf-8",
            mode="a",
        )
...
def main():
    ...
    promptMaker = PromptMaker(contextDB, "characterConfig/ネオン/identity.txt", "ネオン")
